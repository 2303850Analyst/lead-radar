...
- Добавлен выбираемый серверный источник `2gis`: при
  ...
  нормализует карточки в общий контракт LeadRadar. Введённый адрес пока
  геокодируется существующим Geoapify-слоем; автоматического смешивания выдач
  двух источников нет. Пустой валидный ответ 2GIS становится `success_empty`, а
